...
class JenkinsClient:
    ...
    async def request(
        ...
        *,
        ...
        # Return only fixed diagnostics. Even a query-free decoded URL path
        # can contain credentials or control characters. Do not inspect the
        # exception's request property: HTTPX raises RuntimeError when it is unset.
        if (

...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("MCP_PORT", 65536),
        ("MCP_HEALTH_MAX_CONNECTIONS", 0),
        ("MCP_HEALTH_MAX_CONNECTIONS", 1025),
        ("MCP_MAX_REQUEST_TARGET_BYTES", 255),
        ("MCP_MAX_REQUEST_TARGET_BYTES", 65_537),
        ("MCP_MAX_REQUEST_BYTES", 1023),
        ("MCP_MAX_REQUEST_BYTES", 100_000_001),

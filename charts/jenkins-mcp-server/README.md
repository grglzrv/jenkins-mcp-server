...
| `mcp.redactParameterPatterns` | `[]` — additional case-insensitive globs for local secret parameter names whose values `get_build_info` redacts; built-in password/token/credential detection remains active |
